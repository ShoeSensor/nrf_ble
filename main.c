...
//static os_semHandle_t sem;
//static os_timerHandle_t accelTimerHandle;
...
//{
//    uart_write((char*)p_file_name, strlen((const char*)p_file_name));
...
//{
//    uart_write("bleEventHandler", 16);
//    dm_ble_evt_handler(bleEvent);
//    ble_conn_params_on_ble_evt(bleEvent);
//    ble_advertising_on_ble_evt(bleEvent);
//    ble_accSrvBleHandleEvent(accSrvHandle, bleEvent);
//    switch(bleEvent->header.evt_id) {
//        case BLE_GAP_EVT_CONNECTED:
//            connHandle = bleEvent->evt.gap_evt.conn_handle;
//            uart_write("connect\n", 8);
//            break;
//        case BLE_GAP_EVT_DISCONNECTED:
//            uart_write("disconnect\n", 11);
...
//{
//    uart_write("bleAdvHandler\n", 14);
//}
//
//static void connParamHandler(ble_conn_params_evt_t *connParamEvent)
//{
//    uint32_t errCode;
//    if(connParamEvent->evt_type == BLE_CONN_PARAMS_EVT_FAILED) {
//        uart_write("Connection params failed\n", 25);
//        errCode = sd_ble_gap_disconnect(connHandle,
//                BLE_HCI_CONN_INTERVAL_UNACCEPTABLE);
//        APP_ERROR_CHECK(errCode);
//    } else {
//        uart_write("Connection params accepted\n", 27);
//    }
//}
//
...
//{
//    while(1) {
//        while(os_semWait(sem) == false);
//        intern_softdevice_events_execute();
//    }
//}
//
////static void disServiceInit(void)
////{
...
//    };
//
//    os_timerConfig_t accelTimerConf = {
//            .name = "accel",
//            .period = 1000,
//            .oneShot = false,
//            .callback = accelSrvTimerTask
//    };
//
//    ble_accSrvConfig_t accSrvConf = {
//            .accelHandle = NULL
//    };
//
...
//    ble_uuid_t advUuids[] = {
//            {ACC_UUID_SERVICE, ble_accSrvGetUuidType(accSrvHandle)}
//    };
//
//    conn_gapParamsInit(DEVICE_NAME);
//    conn_advertisingInit(advUuids, 1, bleAdvHandler);
//    conn_paramsInit(connParamHandler);
//
//    accelTimerHandle = os_timerTaskNew(&accelTimerConf, OSTIMER_WAIT_FOR_QUEUE);
...
static TimerHandle_t accelSrvTimer;
...
static void timers_init(void)
{
    ...
    accelSrvTimer = xTimerCreate("AST", 1000, true, NULL, accSrVTimeout);
...
static void application_timers_start(void)
{
    ...
    xTimerStart(accelSrvTimer, OSTIMER_WAIT_FOR_QUEUE);
